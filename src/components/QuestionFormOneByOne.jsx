...
export default function QuestionFormOneByOne() {
  ...
  // Validation logic: All options filled, at least one correct answer, and question text is not empty
  const isFormValid =
    question.text.trim() &&
...
//     <form
//       onSubmit={handleSubmit}
//       className="p-6 rounded-lg max-w-lg mx-auto transition-all duration-300 border transform"
//     >
//       <h2 className="text-2xl text-black font-bold mb-5 text-center uppercase tracking-widest">
//         Add Your Question
//       </h2>
//       <div className="mb-4">
//         <label className="block text-black text-sm font-semibold text-gray-700 mb-2">
//           Question
//         </label>
//         <textarea
//           value={question.text}
...
//       <button
//         type="submit"
//         className="w-full py-3 text-black font-semibold rounded-lg border border-bg-blue-900 hover:from-blue-600 hover:to-purple-600 focus:outline-none transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-xl"
//       >
//         Submit Question
//       </button>
//     </form>
